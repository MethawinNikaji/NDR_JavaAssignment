...
//  Student Class 
        ...
        student.addCourseGrade("Math", 95);//display from  public void addCourseGrade in Student class
...
//  Teacher Class
        ...
        teacher.addCourse("Calculus");// display from public void addCourseGrade in Student class
        ...
        System.out.println("Removing 'Physics': "
                + teacher.removeCourse("Physics"));//public boolean removeCourse from Student class
